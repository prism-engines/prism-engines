-- 2025_12_22_geometry_assembly.sql
-- Geometry Assembly Schema: Phase-1 tables for constructed system geometry
--
-- Tables:
--   phase1.geometry_vectors - System geometry vectors per (run_id, indicator_id, window)
--   phase1.geometry_trajectories - Geometry trajectories (time series of geometry vectors)
--   phase1.geometry_coordinate_frames - Coordinate frame definitions
--   phase1.geometry_engine_mapping - Engine-to-geometry mapping
-- Views:
--   phase1.v_geometry_with_trajectory - Geometry vectors with trajectory context
--   phase1.v_indicators_with_geometry - Indicators with complete geometry


-- System geometry vectors per (run_id, indicator_id, window)
CREATE TABLE phase1.geometry_vectors (
...
CREATE TABLE phase1.geometry_trajectories (
    run_id              TEXT NOT NULL,
    indicator_id        TEXT NOT NULL,
    window_years        REAL NOT NULL,
...
CREATE TABLE phase1.geometry_coordinate_frames (
    run_id              TEXT NOT NULL,
...
CREATE TABLE phase1.geometry_engine_mapping (
    run_id              TEXT NOT NULL,
    indicator_id        TEXT NOT NULL,
    window_years        REAL NOT NULL,
...
CREATE OR REPLACE VIEW phase1.v_geometry_with_trajectory AS
SELECT
    gv.*,
    gt.n_points,
    gt.total_distance,
...
CREATE OR REPLACE VIEW phase1.v_indicators_with_geometry AS
SELECT DISTINCT
    run_id,
    indicator_id,
    window_years,
