-- =============================================================================
-- PRISM Temporal Persistence Schema
-- Phase-1 annotations for geometry continuity and stability
-- =============================================================================

-- Persistence metrics per (run_id, indicator_id, window_years)
CREATE TABLE IF NOT EXISTS phase1.temporal_persistence (
...
CREATE TABLE IF NOT EXISTS phase1.detected_transitions (
    run_id              TEXT NOT NULL,
    indicator_id        TEXT NOT NULL,
    window_years        REAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS phase1.window_continuity (
    run_id              TEXT NOT NULL,
    indicator_id        TEXT NOT NULL,
    window_years        REAL NOT NULL,
...
CREATE VIEW IF NOT EXISTS phase1.v_persistent_indicators AS
SELECT *
...
CREATE VIEW IF NOT EXISTS phase1.v_transitions_with_context AS
SELECT 
    dt.*,
