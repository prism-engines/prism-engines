-- =============================================================================
-- PRISM Cross-Engine Agreement Schema
-- Phase-1 annotations for structural coherence detection
-- =============================================================================

-- Agreement scores per (run_id, indicator_id, window_years)
CREATE TABLE IF NOT EXISTS phase1.cross_engine_agreement (
...
CREATE TABLE IF NOT EXISTS phase1.engine_pair_agreement (
    run_id              TEXT NOT NULL,
    indicator_id        TEXT NOT NULL,
    window_years        REAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS phase1.engine_contradictions (
    run_id              TEXT NOT NULL,
    indicator_id        TEXT NOT NULL,
    window_years        REAL NOT NULL,
...
CREATE VIEW IF NOT EXISTS phase1.v_high_agreement_indicators AS
SELECT *
...
CREATE VIEW IF NOT EXISTS phase1.v_contradicting_indicators AS
SELECT 
    cea.run_id,
    cea.indicator_id,
    cea.window_years,
