...
Dynamic Mode Decomposition for dynamic mode structure.
...
class DMDEngine(BaseEngine):
    ...
    Captures oscillatory behavior, stability, and dynamical structure.
    
    Aligns with PRISM's "waves/vibrations" framing.
    
    Outputs:
        - structure.dmd_modes: Eigenvalue summaries
        - structure.dmd_reconstruction: Reconstruction error
    """
