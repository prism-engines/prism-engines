...
from prism.db.connection import get_connection, get_db_path
...
def main():
    ...
    p.add_argument("--db", default=str(get_db_path()), help="Path to DuckDB file")
    ...
    conn = get_connection(Path(args.db), read_only=True)
